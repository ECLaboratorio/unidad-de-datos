...
datosMuertesHistograma <- read.csv('https://docs.google.com/spreadsheets/d/e/2PACX-1vQVo0EJNeZWoF4XruYd0BnoHyWxgInurmI3iAWJRZplmYF7_YzGvesj1onZdfY3dbHI6-FRHkuQYXon/pub?gid=939250240&single=true&output=csv')
datosMapa <- read.csv('https://docs.google.com/spreadsheets/d/e/2PACX-1vQVo0EJNeZWoF4XruYd0BnoHyWxgInurmI3iAWJRZplmYF7_YzGvesj1onZdfY3dbHI6-FRHkuQYXon/pub?gid=905422202&single=true&output=csv')
datosUltimos7dias <- read.csv('https://docs.google.com/spreadsheets/d/e/2PACX-1vQVo0EJNeZWoF4XruYd0BnoHyWxgInurmI3iAWJRZplmYF7_YzGvesj1onZdfY3dbHI6-FRHkuQYXon/pub?gid=302214376&single=true&output=csv')
